 ...
 * 读取配置文件文件
 * */
_.getConfig = function(path){
	if (_.exists(path)) {
		try {
			var data = _.readJSON(path);
			if (data) {
				if (typeof(data) == 'object') {
					data = _.extend(_.config._data, data);
				}
				return data;
			}
		} catch (e) {
			console.log('config.json format error');
			console.log(e);
		}
	} else {
